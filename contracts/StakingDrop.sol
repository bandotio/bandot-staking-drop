...
contract StakingDrop is Ownable {
    ...
    constructor(
        ...
        require(
            hbtcAddress_ != address(0),
            "StakingDrop: hbtcAddress_ is zero address"
        );
        require(
            bdtAddress_ != address(0),
            "StakingDrop: bdtAddress_ is zero address"
        );
    ...
    function withdraw(uint256 amount) external {
        ...
        require(
            ...
            "StakingDrop: withdraw transfer failed"
        );
    ...
    function deposit(uint256 _value) external {
        ...
        require(
            ...
            "StakingDrop: deposit transferFrom failed"
        );
    ...
    function claimRewards() public {
        ...
        if (myLastClaimedAt[msg.sender] >= bonusStartAt) {
            ...
            require(
                ...
                "StakingDrop: claimRewards transfer failed"
            );
        ...
        returns (uint256)
    {
        ...
        uint256 myDuration =
            block.timestamp > bonusStartAt.add(BONUS_DURATION)
